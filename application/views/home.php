...
<head>
	...
	<link rel="shortcut icon" href="<?php echo base_url('assets/frontend/images/gt_favicon.png')?>">
	
	<!-- Bootstrap -->
	<link href="<?php echo base_url('assets/frontend/css/bootstrap.no-icons.min.css')?>" rel="stylesheet">
	<!-- Icons -->
...
<header id="header">
	<div id="head" class="parallax" parallax-speed="2">
		<h1 id="logo" class="text-center">
			<img class="img-circle" src="<?php echo base_url()?>assets/frontend/images/guy.jpg" alt="">
...
<main id="main">
	...
	<div class="container">
			...
			<div class="thumbnails recentworks row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					<a class="thumbnail" href="sidebar-right.html">
						<span class="img">
							<img src="<?php echo base_url()?>assets/frontend/images/s1.jpg" alt="">
		...
		<div class="row section clients topspace">
			...
			<div class="col-lg-12">
				<p>
					<img src="<?php echo base_url()?>assets/frontend/images/sample_clients.png" alt="">
				</p>
			</div>
		</div> <!-- /section -->
...
<script src="<?php echo base_url()?>assets/frontend/js/1.10.2/jquery.min.js"></script>
